...
import { EventItem } from "@/app/(dashboard)/(mailbox)/[category]/conversation/eventItem";
import MessageItem from "@/app/(dashboard)/(mailbox)/[category]/conversation/messageItem";
