...
export const MessageActionButtons = ({
  ...
  return (
    <div className="flex items-center gap-4 md:flex-row-reverse">
      ...
      >
        Reply
        {!sending && isMacOS() && <KeyboardShortcut className="ml-2 text-sm border-primary/50">⌥⏎</KeyboardShortcut>}
      </Button>
      <Button size={isAboveMd ? "default" : "sm"} onClick={() => onSend({ assign: false })} disabled={sendDisabled}>
