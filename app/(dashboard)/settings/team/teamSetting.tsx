...
import { Section } from "@/app/(dashboard)/settings/sectionWrapper";
...
const TeamSettingSection = ({ children }: { children: ReactNode }) => {
  return <section className={"flex flex-col gap-8 border-b py-8 first:pt-4 "}>{children}</section>;
};
        ...
        <div className="w-full space-y-6">
          ...
          <div className="text-sm text-muted-foreground space-y-1">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                Only {ROLE_DISPLAY_NAMES.core} support team members will be mentioned explicitly in weekly reports.
              </li>
            </ul>
          </div>
        </div>
