        ...
        <div className="rounded-2xl overflow-hidden bg-[#6348474D] h-full">
          ...
          <div className="flex h-[calc(100%-3rem)]">
            <aside className="flex flex-col gap-2 py-12 pl-4 md:pl-8 pr-2 md:pr-4 w-32 md:w-48 min-w-[100px] md:min-w-[140px] bg-transparent">
              <span className="text-[#FFE6B0] text-sm md:text-base font-semibold px-2 py-1 rounded transition-colors hover:bg-[#2B0808]/60">Dashboard</span>
              <span className="text-[#FFE6B0] text-sm md:text-base font-semibold px-2 py-1 rounded transition-colors border-l-4 border-[#FEB81D] bg-[#3B1B1B]">Orders</span>
              <span className="text-[#FFE6B0] text-sm md:text-base font-semibold px-2 py-1 rounded transition-colors hover:bg-[#2B0808]/60">Profile</span>
              <span className="text-[#FFE6B0] text-sm md:text-base font-semibold px-2 py-1 rounded transition-colors hover:bg-[#2B0808]/60">Wishlist</span>
              <span className="text-[#FFE6B0] text-sm md:text-base font-semibold px-2 py-1 rounded transition-colors hover:bg-[#2B0808]/60">Settings</span>
            </aside>
                  ...
                  >
                    ...
                    {messageDone && (
                      ...
                      >
                        ...
                        >
                          <span className="bg-[#FEB81D] text-black text-xs md:text-sm font-medium rounded-full px-3 md:px-4 py-1 mb-1 ml-3" style={{borderRadius:'9999px'}}>
                            Helper
                          </span>
        ...
        <div className="absolute" style={{top:'78%',right:'-10px',zIndex:30}}>
          <div className="bg-[#250404] border border-[#FEB81D80] rounded-xl px-4 md:px-8 py-5 md:py-7 w-[320px] md:w-[440px] mt-8 md:mt-0">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-sm md:text-base text-[#FFE6B0]">Requesting a refund on your most recent order</span>
            </div>
            ...
            <div className="flex flex-col gap-4 md:gap-5 mt-2">
              <div className="flex items-center gap-3">
                <span className="w-3 h-3 md:w-4 md:h-4 rounded-full bg-[#C2D44B] flex items-center justify-center"><span className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-[#250404]" /></span>
