    ...
    <div className="max-w-4xl bg-white p-6 rounded-lg shadow">
      ...
      <div className="flex flex-col md:flex-row justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-600 mb-2">
            Once the code is created, you can share it or copy a unique link per product that automatically applies the discount.
          </p>
      ...
      <div className="space-y-6">
        ...
        <div>
          <label htmlFor="discount-code" className="block text-gray-700 mb-2">Discount code</label>
          <div className="flex">
            <input 
              type="text" 
              id="discount-code" 
        ...
        <div>
          <label htmlFor="products" className="block text-gray-700 mb-2">Products</label>
          <input 
            type="text" 
            id="products" 
          ...
          <div className="flex items-center">
            <input 
              ...
              className="mr-2" 
            />
            <label htmlFor="all-products" className="text-gray-700">All products</label>
          </div>
        </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center">
              <input 
                ...
                className="mr-2" 
              />
              <label htmlFor="limit-quantity" className="text-gray-700">Limit quantity</label>
            </div>
            <div className="flex items-center">
              <input 
                type="checkbox" 
                ...
                className="mr-2" 
              />
              <label htmlFor="limit-validity" className="text-gray-700">Limit validity period</label>
            </div>
            <div className="flex items-center">
              <input 
                type="checkbox" 
                ...
                className="mr-2" 
              />
              <label htmlFor="min-amount" className="text-gray-700">Set a minimum qualifying amount</label>
            </div>
            <div className="flex items-center">
              <input 
                type="checkbox" 
                ...
                className="mr-2" 
              />
              <label htmlFor="min-quantity" className="text-gray-700">Set a minimum quantity</label>
            </div>
          </div>
        </div>
      </div>
