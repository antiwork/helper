CREATE TYPE "public"."guide_session_event_type" AS ENUM('session_started', 'status_changed', 'step_added', 'step_completed', 'step_updated', 'completed', 'abandoned', 'paused');--> statement-breakpoint
