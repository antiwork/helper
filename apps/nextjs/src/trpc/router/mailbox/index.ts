  ...
  update: mailboxProcedure
    .input(
      z.object({
        ...
        ticketResponseAlertsEnabled: z.boolean().optional(),
        ticketResponseAlertsFrequency: z.enum(["hourly", "daily", "weekly"]).optional(),
        ticketResponseAlertsChannel: z.string().optional(),
