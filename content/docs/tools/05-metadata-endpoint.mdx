...
Verifying that requests are genuinely from Helper is an important security practice that prevents unauthorized access to your customer data. Without this verification, malicious actors could potentially forge requests to your endpoint to extract sensitive customer information.
