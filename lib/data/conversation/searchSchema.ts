...
export const searchSchema = z.object({
  ...
  closed: z
    .object({
      by: z.enum(["human"]).optional().describe("Filter tickets closed by a human"),
  ...
  reopened: z
    .object({
      by: z.enum(["human"]).optional().describe("Filter tickets reopened by a human"),
  ...
  markedAsSpam: z
    .object({
      by: z.enum(["human"]).optional().describe("Filter tickets marked as spam by a human"),
      byUserId: z.array(z.string().uuid()).optional().describe("Filter tickets marked as spam by specific team members"),
