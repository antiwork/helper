...
The certificates will be automatically generated when you run `pnpm dev` and `pnpm db:reset`, for the first time. If you need to regenerate them you can use:
