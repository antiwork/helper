...
pnpm services:start > /dev/null 2>&1 || echo "   ⚠️  Services might already be running"
...
echo ""
echo "   2. Update your .env.local file with correct test credentials"
echo ""
...
echo "   • Check test credentials in .env.local"
echo ""
echo "Happy testing! 🚀" 