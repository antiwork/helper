...
describe("getMessages Edge Cases & Null Handling", () => {
  describe("Staff Messages with Null UserId", () => {
  ...
  describe("Notes with Null UserId", () => {
  ...
  describe("Events with Null User IDs", () => {
